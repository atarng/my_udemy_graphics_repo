...
*/
function createCylinderFromEnds( material, radiusTop, radiusBottom,
																 top, bottom, segmentsWidth, openEnded) {
	// defaults
	...
	cylAxis.subVectors(top, bottom); // top - bottom
	let length = cylAxis.length();
	
	let center = new THREE.Vector3();
	center.addVectors(top, bottom); // top + bottom
