...
function fillScene() {
	...
	// headMaterial.diffuse.copy(headMaterial.color);
	...
	// crossbarMaterial.diffuse.copy( crossbarMaterial.color );
	// eyeMaterial.diffuse.copy( eyeMaterial.color );
